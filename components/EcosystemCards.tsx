  ...
  return (
    <section className="ecosystem-section">
      ...
      <div className="ecosystem-grid">
        {[
          { name: 'Image Editor', icon: '✏️', desc: 'AI-powered image editing',      status: 'Available Now',  isActive: true,  href: 'https://image-editor.deepvortexai.com', isCurrent: true  },
          ...
          { name: 'Image Gen',    icon: '🎨', desc: 'AI artwork from text',         status: 'Available Now',  isActive: true,  href: 'https://images.deepvortexai.com',       isCurrent: false },
