...
const tools = [
  { name: 'Image Editor', icon: '✏️', desc: 'AI-powered image editing',          href: 'https://image-editor.deepvortexai.com', isCurrent: true  },
  { name: 'Emoticons',    icon: '😃', desc: 'Custom emoji creation',              href: 'https://emoticons.deepvortexai.com',    isCurrent: false },
  { name: 'Image Gen',    icon: '🎨', desc: 'AI artwork from text',              href: 'https://images.deepvortexai.com',       isCurrent: false },
